...
**操作に慣れたら、ControlRigを使うことをオススメします。このページはVRM4U独自機能によるお手軽セットアップを解説しています。**
{: .notice--info}
...
UEの標準的なセットアップを行う場合は、[前章のアニメーション](../01_animation/)や、[後述のControlRig](../06_controlrig/)を参照し、手動で設定ください。
